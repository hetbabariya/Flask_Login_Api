...
class FollowRequest(db.Model):
    ...
    request_by_user_id = db.Column(UUID(as_uuid=True), db.ForeignKey("user.id") , nullable = False , index = True)
    ...
    followRequest_request_id_table_user_relation = db.relationship('User' , back_populates = "followRequest_requestid_user_relation" , foreign_keys = [request_by_user_id])